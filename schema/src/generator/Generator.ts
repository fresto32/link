...
import ConfigSettings from '../card/Config';
import Landmarks from './Landmarks';
import ResourcesSettings from '../card/Resources';
import WorldSettings from '../card/objects/World';
...
export class CardSettingsGenerator implements CardSettings {
  ...
  private setPrompt() {
    this.world.prompt.text = 'What is an example of an O(n) sorting algorithm?';
  }
